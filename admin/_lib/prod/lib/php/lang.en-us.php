...
$nm_lang['copyright_label'] = 'NetMake. All rights reserved';
$nm_lang['version'] = 'Version';
$nm_lang['title_new_update'] = 'New version of the Production Environment!';
...
$nm_lang['form_pass_email']           = 'Recovery email';
$nm_lang['form_pass_conf']            = 'Confirm new password';
$nm_lang['form_pass_new']             = 'New password';
$nm_lang['form_pass_old']             = 'Old password';
$nm_lang['form_pass_help_title']      = 'Password must contain:';
$nm_lang['form_pass_help_desc_1']     = 'Minimum 8 characters';
$nm_lang['form_pass_help_desc_2']     = 'Uppercase and lowercase letters';
$nm_lang['form_pass_help_desc_3']     = 'Minimum one number';
$nm_lang['form_pass_help_desc_4']     = 'The password and confirmation must be equal.';
$nm_lang['form_pass_help_desc_5']     = 'Valid email';
...
$nm_lang['error_password_old_new']         = 'The new password must be different from the old password.';
$nm_lang['error_password_email']           = 'Invalid email.';
...
$nm_lang['confirm_delete_preprofile'] = "Are you sure you want to delete this profile?<br>The interface won't criticizes to create this profile anymore.";
