    ...
    <form action="" onsubmit="return false;" name="form_create" METHOD="post" class="ui form">
        ...
        <div id='tab_new_conn'>
            ...
            <div id='tr_security' class="ui bottom attached tab segment" data-tab="tr_security" style="">
                ...
                <div class="field" id='tr_use_ssl' style="display:<?php echo $obj_conn->nm_db_sc_type($dbms) != 'mysql' ? 'none' : ''; ?>">
                ...
                <div class="two fields" >
                    <div class="twelve wide field" id='tr_mysql_ssl_key' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
                    ...
                    <div class="twelve wide field" id='tr_mysql_ssl_cert' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
                ...
                <div class="two fields" >
                    <div class="field" id='tr_mysql_ssl_capath' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
                    ...
                    <div class="field" id='tr_mysql_ssl_ca' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
                ...
                <div class="field" id='tr_mysql_ssl_cipher' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
