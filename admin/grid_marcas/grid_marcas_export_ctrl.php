<?php
@session_start() ;
$_SESSION['scriptcase']['grid_marcas']['sc_process_barr'] = true;
require_once('../grid_marcas/index.php');
unset($_SESSION['scriptcase']['grid_marcas']['sc_process_barr']);
$ExportCtrl = new grid_marcas_export_control;
$ExportCtrl->Export_barr();

class grid_marcas_export_control
{
