...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_creditos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_creditos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_creditos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_creditos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_creditos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_creditos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_creditos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_creditos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_creditos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_creditos']['embutida_filho'] as $ind => $sc_init)
          {
