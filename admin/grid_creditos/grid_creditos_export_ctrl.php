<?php
@session_start() ;
$_SESSION['scriptcase']['grid_creditos']['sc_process_barr'] = true;
require_once('../grid_creditos/index.php');
unset($_SESSION['scriptcase']['grid_creditos']['sc_process_barr']);
$ExportCtrl = new grid_creditos_export_control;
$ExportCtrl->Export_barr();

class grid_creditos_export_control
{
