...
<?php
   ...
   $Ord_Cmp = new grid_creditos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_creditos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_credito'] = "id_credito";
   $tab_labels["id_credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["id_credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["id_credito"] : "ID";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["credito"] : "Crédito";
   $tab_ger_campos['url_f'] = "on";
   $tab_def_campos['url_f'] = "url_f";
   $tab_labels["url_f"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["url_f"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["url_f"] : "URL Puente";
   $tab_ger_campos['img'] = "on";
   $tab_def_campos['img'] = "img";
   $tab_labels["img"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["img"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["img"] : "Imagen";
   $tab_ger_campos['estilo'] = "on";
   $tab_def_campos['estilo'] = "estilo";
   $tab_labels["estilo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["estilo"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["estilo"] : "Estilo";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditos']['labels']["descripcion"] : "Descripción";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_creditos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_creditos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_creditos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_creditos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
