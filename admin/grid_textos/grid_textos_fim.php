...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_textos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_textos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_textos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_textos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_textos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_textos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_textos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_textos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_textos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_textos']['embutida_filho'] as $ind => $sc_init)
          {
