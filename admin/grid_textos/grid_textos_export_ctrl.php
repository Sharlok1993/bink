<?php
@session_start() ;
$_SESSION['scriptcase']['grid_textos']['sc_process_barr'] = true;
require_once('../grid_textos/index.php');
unset($_SESSION['scriptcase']['grid_textos']['sc_process_barr']);
$ExportCtrl = new grid_textos_export_control;
$ExportCtrl->Export_barr();

class grid_textos_export_control
{
