...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT group_id, description  FROM secc_groups  ORDER BY description"; 
      unset($cmp1,$cmp2);
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FinancialOwn/sec_grid_sec_users_groups";
