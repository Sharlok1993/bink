...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FinancialOwn_____sec_search_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FinancialOwn_____sec_search_sec_groups"]);
   }
