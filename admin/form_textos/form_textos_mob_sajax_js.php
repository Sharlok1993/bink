  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_textos_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_textos
  function do_ajax_form_textos_mob_validate_id_textos()
  {
    var nomeCampo_id_textos = "id_textos";
    var var_id_textos = scAjaxGetFieldHidden(nomeCampo_id_textos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_mob_validate_id_textos(var_id_textos, var_script_case_init, do_ajax_form_textos_mob_validate_id_textos_cb);
  } // do_ajax_form_textos_mob_validate_id_textos

  function do_ajax_form_textos_mob_validate_id_textos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_textos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_mob_validate_id_textos_cb

  // ---------- Validate id_credito
  function do_ajax_form_textos_mob_validate_id_credito()
  {
    var nomeCampo_id_credito = "id_credito";
    var var_id_credito = scAjaxGetFieldSelect(nomeCampo_id_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_mob_validate_id_credito(var_id_credito, var_script_case_init, do_ajax_form_textos_mob_validate_id_credito_cb);
  } // do_ajax_form_textos_mob_validate_id_credito

  function do_ajax_form_textos_mob_validate_id_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_mob_validate_id_credito_cb

  // ---------- Validate disclaimers
  function do_ajax_form_textos_mob_validate_disclaimers()
  {
    var nomeCampo_disclaimers = "disclaimers";
    var var_disclaimers = scAjaxGetFieldEditorHtml(nomeCampo_disclaimers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_mob_validate_disclaimers(var_disclaimers, var_script_case_init, do_ajax_form_textos_mob_validate_disclaimers_cb);
  } // do_ajax_form_textos_mob_validate_disclaimers

  function do_ajax_form_textos_mob_validate_disclaimers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disclaimers";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_mob_validate_disclaimers_cb

  // ---------- Validate terminos
  function do_ajax_form_textos_mob_validate_terminos()
  {
    var nomeCampo_terminos = "terminos";
    var var_terminos = scAjaxGetFieldEditorHtml(nomeCampo_terminos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_mob_validate_terminos(var_terminos, var_script_case_init, do_ajax_form_textos_mob_validate_terminos_cb);
  } // do_ajax_form_textos_mob_validate_terminos

  function do_ajax_form_textos_mob_validate_terminos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "terminos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_mob_validate_terminos_cb

  // ---------- Validate doc_terminos
  function do_ajax_form_textos_mob_validate_doc_terminos()
  {
    var nomeCampo_doc_terminos = "doc_terminos";
    var var_doc_terminos = scAjaxGetFieldText(nomeCampo_doc_terminos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_mob_validate_doc_terminos(var_doc_terminos, var_script_case_init, do_ajax_form_textos_mob_validate_doc_terminos_cb);
  } // do_ajax_form_textos_mob_validate_doc_terminos

  function do_ajax_form_textos_mob_validate_doc_terminos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doc_terminos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_mob_validate_doc_terminos_cb

  // ---------- Validate id_status
  function do_ajax_form_textos_mob_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_mob_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_textos_mob_validate_id_status_cb);
  } // do_ajax_form_textos_mob_validate_id_status

  function do_ajax_form_textos_mob_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_mob_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_textos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_textos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_textos = scAjaxGetFieldHidden("id_textos");
    var var_id_credito = scAjaxGetFieldSelect("id_credito");
    var var_disclaimers = scAjaxGetFieldEditorHtml("disclaimers");
    var var_terminos = scAjaxGetFieldEditorHtml("terminos");
    var var_doc_terminos = scAjaxGetFieldText("doc_terminos");
    var var_id_status = scAjaxGetFieldSelect("id_status");
    var var_doc_terminos_ul_name = scAjaxSpecCharProtect(document.F1.doc_terminos_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_doc_terminos_ul_type = document.F1.doc_terminos_ul_type.value;
    var var_doc_terminos_salva = scAjaxSpecCharProtect(document.F1.doc_terminos_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_doc_terminos_limpa = document.F1.doc_terminos_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_textos_mob_submit_form(var_id_textos, var_id_credito, var_disclaimers, var_terminos, var_doc_terminos, var_id_status, var_doc_terminos_ul_name, var_doc_terminos_ul_type, var_doc_terminos_salva, var_doc_terminos_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_textos_mob_submit_form_cb);
  } // do_ajax_form_textos_mob_submit_form

  function do_ajax_form_textos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_textos");
      scAjaxHideErrorDisplay("id_credito");
      scAjaxHideErrorDisplay("disclaimers");
      scAjaxHideErrorDisplay("terminos");
      scAjaxHideErrorDisplay("doc_terminos");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.doc_terminos_limpa && document.F1.doc_terminos_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("doc_terminos", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_doc_terminos") && "" != document.getElementById("id_ajax_doc_doc_terminos").innerHTML)
      {
        document.getElementById("id_ajax_doc_doc_terminos").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_textos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_textos_mob_submit_form_cb
  function do_ajax_form_textos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_textos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_textos_mob_navigate_form()
  {
    perform_ajax_form_textos_mob_navigate_form();
  }

  function perform_ajax_form_textos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("doc_terminos");
    scAjaxHideErrorDisplay("id_status");
    var var_id_textos = document.F2.id_textos.value;
    ...
    scAjaxProcOn();
    x_ajax_form_textos_mob_navigate_form(var_id_textos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_textos_mob_navigate_form_cb);
  } // do_ajax_form_textos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_textos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_textos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_textos.value = scAjaxGetKeyValue("id_textos");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_textos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_textos_mob_navigate_form_cb
  function do_ajax_form_textos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_textos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_textos_mob_navigate_form_cb_after_alert

  function sc_hide_form_textos_mob_form()
  {
  ...
  ajax_field_list[0] = "id_textos";
  ajax_field_list[1] = "id_credito";
  ajax_field_list[2] = "disclaimers";
  ajax_field_list[3] = "terminos";
  ajax_field_list[4] = "doc_terminos";
  ajax_field_list[5] = "id_status";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_textos": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_credito": {"label": "Crédito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "disclaimers": {"label": "Disclaimer", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "terminos": {"label": "Términos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "doc_terminos": {"label": "Doc Términos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "disclaimers": new Array(),
    "terminos": new Array(),
    "doc_terminos": new Array(),
    "id_status": new Array()
  };
  ajax_field_mult["id_textos"][1] = "id_textos";
  ajax_field_mult["id_credito"][1] = "id_credito";
  ajax_field_mult["disclaimers"][1] = "disclaimers";
  ajax_field_mult["terminos"][1] = "terminos";
  ajax_field_mult["doc_terminos"][1] = "doc_terminos";
  ajax_field_mult["id_status"][1] = "id_status";

  var ajax_field_id = {
    "id_textos": new Array("hidden_field_label_id_textos", "hidden_field_data_id_textos"),
    "id_credito": new Array("hidden_field_label_id_credito", "hidden_field_data_id_credito"),
    "disclaimers": new Array("hidden_field_label_disclaimers", "hidden_field_data_disclaimers"),
    "doc_terminos": new Array("hidden_field_label_doc_terminos", "hidden_field_data_doc_terminos"),
