  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_textos" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_textos
  function do_ajax_form_textos_validate_id_textos()
  {
    var nomeCampo_id_textos = "id_textos";
    var var_id_textos = scAjaxGetFieldHidden(nomeCampo_id_textos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_validate_id_textos(var_id_textos, var_script_case_init, do_ajax_form_textos_validate_id_textos_cb);
  } // do_ajax_form_textos_validate_id_textos

  function do_ajax_form_textos_validate_id_textos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_validate_id_textos_cb

  // ---------- Validate id_credito
  function do_ajax_form_textos_validate_id_credito()
  {
    var nomeCampo_id_credito = "id_credito";
    var var_id_credito = scAjaxGetFieldSelect(nomeCampo_id_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_validate_id_credito(var_id_credito, var_script_case_init, do_ajax_form_textos_validate_id_credito_cb);
  } // do_ajax_form_textos_validate_id_credito

  function do_ajax_form_textos_validate_id_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_validate_id_credito_cb

  // ---------- Validate disclaimers
  function do_ajax_form_textos_validate_disclaimers()
  {
    var nomeCampo_disclaimers = "disclaimers";
    var var_disclaimers = scAjaxGetFieldEditorHtml(nomeCampo_disclaimers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_validate_disclaimers(var_disclaimers, var_script_case_init, do_ajax_form_textos_validate_disclaimers_cb);
  } // do_ajax_form_textos_validate_disclaimers

  function do_ajax_form_textos_validate_disclaimers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_validate_disclaimers_cb

  // ---------- Validate terminos
  function do_ajax_form_textos_validate_terminos()
  {
    var nomeCampo_terminos = "terminos";
    var var_terminos = scAjaxGetFieldEditorHtml(nomeCampo_terminos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_validate_terminos(var_terminos, var_script_case_init, do_ajax_form_textos_validate_terminos_cb);
  } // do_ajax_form_textos_validate_terminos

  function do_ajax_form_textos_validate_terminos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_validate_terminos_cb

  // ---------- Validate doc_terminos
  function do_ajax_form_textos_validate_doc_terminos()
  {
    var nomeCampo_doc_terminos = "doc_terminos";
    var var_doc_terminos = scAjaxGetFieldText(nomeCampo_doc_terminos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_validate_doc_terminos(var_doc_terminos, var_script_case_init, do_ajax_form_textos_validate_doc_terminos_cb);
  } // do_ajax_form_textos_validate_doc_terminos

  function do_ajax_form_textos_validate_doc_terminos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_validate_doc_terminos_cb

  // ---------- Validate id_status
  function do_ajax_form_textos_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_textos_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_textos_validate_id_status_cb);
  } // do_ajax_form_textos_validate_id_status

  function do_ajax_form_textos_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_textos_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_textos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_textos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_textos_submit_form(var_id_textos, var_id_credito, var_disclaimers, var_terminos, var_doc_terminos, var_id_status, var_doc_terminos_ul_name, var_doc_terminos_ul_type, var_doc_terminos_salva, var_doc_terminos_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_textos_submit_form_cb);
  } // do_ajax_form_textos_submit_form

  function do_ajax_form_textos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_textos_submit_form_cb_after_alert);
  } // do_ajax_form_textos_submit_form_cb
  function do_ajax_form_textos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_textos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_textos_navigate_form()
  {
    perform_ajax_form_textos_navigate_form();
  }

  function perform_ajax_form_textos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_textos_navigate_form(var_id_textos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_textos_navigate_form_cb);
  } // do_ajax_form_textos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_textos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_textos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_textos_navigate_form_cb_after_alert);
  } // do_ajax_form_textos_navigate_form_cb
  function do_ajax_form_textos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_textos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_textos_navigate_form_cb_after_alert

  function sc_hide_form_textos_form()
  {
