<?php
@session_start() ;
$_SESSION['scriptcase']['grid_valores']['sc_process_barr'] = true;
require_once('../grid_valores/index.php');
unset($_SESSION['scriptcase']['grid_valores']['sc_process_barr']);
$ExportCtrl = new grid_valores_export_control;
$ExportCtrl->Export_barr();

class grid_valores_export_control
{
