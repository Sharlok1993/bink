...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_valores"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_valores"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_valores'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_valores']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_valores']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_valores']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_valores']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_valores']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_valores']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_valores']['embutida_filho'] as $ind => $sc_init)
          {
