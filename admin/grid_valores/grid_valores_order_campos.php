<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_valores']['glo_nm_path_imag_temp'] . "/sc_apl_default_FinancialOwn.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_valores_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_valores_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_valor'] = "on";
   $tab_def_campos['id_valor'] = "id_valor";
   $tab_labels["id_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["id_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["id_valor"] : "ID";
   $tab_ger_campos['factor_seg_vida'] = "on";
   $tab_def_campos['factor_seg_vida'] = "factor_seg_vida";
   $tab_labels["factor_seg_vida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_seg_vida"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_seg_vida"] : "Factor Seg Vida";
   $tab_ger_campos['seg_auto'] = "on";
   $tab_def_campos['seg_auto'] = "seg_auto";
   $tab_labels["seg_auto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["seg_auto"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["seg_auto"] : "Seg Auto";
   $tab_ger_campos['factor_seg_auto'] = "on";
   $tab_def_campos['factor_seg_auto'] = "factor_seg_auto";
   $tab_labels["factor_seg_auto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_seg_auto"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_seg_auto"] : "Factor Seg Auto";
   $tab_ger_campos['factor_comision'] = "on";
   $tab_def_campos['factor_comision'] = "factor_comision";
   $tab_labels["factor_comision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_comision"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_comision"] : "Factor Comisión";
   $tab_ger_campos['factor_comision2'] = "on";
   $tab_def_campos['factor_comision2'] = "factor_comision2";
   $tab_labels["factor_comision2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_comision2"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["factor_comision2"] : "Factor Comisión 2";
   $tab_ger_campos['tia2'] = "on";
   $tab_def_campos['tia2'] = "tia2";
   $tab_labels["tia2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia2"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia2"] : "Tia 2";
   $tab_ger_campos['tia1'] = "on";
   $tab_def_campos['tia1'] = "tia1";
   $tab_labels["tia1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia1"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia1"] : "Tia 1";
   $tab_ger_campos['tia3'] = "on";
   $tab_def_campos['tia3'] = "tia3";
   $tab_labels["tia3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia3"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia3"] : "Tia 3";
   $tab_ger_campos['tia4'] = "on";
   $tab_def_campos['tia4'] = "tia4";
   $tab_labels["tia4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia4"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia4"] : "Tia 4";
   $tab_ger_campos['tia5'] = "on";
   $tab_def_campos['tia5'] = "tia5";
   $tab_labels["tia5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia5"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["tia5"] : "Tia 5";
   $tab_ger_campos['cat'] = "on";
   $tab_def_campos['cat'] = "CAT";
   $tab_labels["cat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["cat"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["cat"] : "CAT";
   $tab_ger_campos['id_status'] = "on";
   $tab_def_campos['id_status'] = "id_status";
   $tab_labels["id_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["id_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['labels']["id_status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_valores']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_valores']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> valores</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_valores_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_valores']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
