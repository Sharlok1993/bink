  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_creditos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_creditos_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_credito
  function do_ajax_form_creditos_mob_validate_id_credito()
  {
    var nomeCampo_id_credito = "id_credito";
    var var_id_credito = scAjaxGetFieldHidden(nomeCampo_id_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_id_credito(var_id_credito, var_script_case_init, do_ajax_form_creditos_mob_validate_id_credito_cb);
  } // do_ajax_form_creditos_mob_validate_id_credito

  function do_ajax_form_creditos_mob_validate_id_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_credito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_id_credito_cb

  // ---------- Validate credito
  function do_ajax_form_creditos_mob_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldText(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_credito(var_credito, var_script_case_init, do_ajax_form_creditos_mob_validate_credito_cb);
  } // do_ajax_form_creditos_mob_validate_credito

  function do_ajax_form_creditos_mob_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "credito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_credito_cb

  // ---------- Validate url_f
  function do_ajax_form_creditos_mob_validate_url_f()
  {
    var nomeCampo_url_f = "url_f";
    var var_url_f = scAjaxGetFieldText(nomeCampo_url_f);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_url_f(var_url_f, var_script_case_init, do_ajax_form_creditos_mob_validate_url_f_cb);
  } // do_ajax_form_creditos_mob_validate_url_f

  function do_ajax_form_creditos_mob_validate_url_f_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url_f";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_url_f_cb

  // ---------- Validate img
  function do_ajax_form_creditos_mob_validate_img()
  {
    var nomeCampo_img = "img";
    var var_img = scAjaxGetFieldText(nomeCampo_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_img(var_img, var_script_case_init, do_ajax_form_creditos_mob_validate_img_cb);
  } // do_ajax_form_creditos_mob_validate_img

  function do_ajax_form_creditos_mob_validate_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "img";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_img_cb

  // ---------- Validate estilo
  function do_ajax_form_creditos_mob_validate_estilo()
  {
    var nomeCampo_estilo = "estilo";
    var var_estilo = scAjaxGetFieldText(nomeCampo_estilo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_estilo(var_estilo, var_script_case_init, do_ajax_form_creditos_mob_validate_estilo_cb);
  } // do_ajax_form_creditos_mob_validate_estilo

  function do_ajax_form_creditos_mob_validate_estilo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estilo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_estilo_cb

  // ---------- Validate descripcion
  function do_ajax_form_creditos_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_creditos_mob_validate_descripcion_cb);
  } // do_ajax_form_creditos_mob_validate_descripcion

  function do_ajax_form_creditos_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_descripcion_cb

  // ---------- Validate banner
  function do_ajax_form_creditos_mob_validate_banner()
  {
    var nomeCampo_banner = "banner";
    var var_banner = scAjaxGetFieldText(nomeCampo_banner);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_banner(var_banner, var_script_case_init, do_ajax_form_creditos_mob_validate_banner_cb);
  } // do_ajax_form_creditos_mob_validate_banner

  function do_ajax_form_creditos_mob_validate_banner_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banner";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_banner_cb

  // ---------- Validate slogan
  function do_ajax_form_creditos_mob_validate_slogan()
  {
    var nomeCampo_slogan = "slogan";
    var var_slogan = scAjaxGetFieldText(nomeCampo_slogan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_slogan(var_slogan, var_script_case_init, do_ajax_form_creditos_mob_validate_slogan_cb);
  } // do_ajax_form_creditos_mob_validate_slogan

  function do_ajax_form_creditos_mob_validate_slogan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "slogan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_slogan_cb

  // ---------- Validate titulo_1
  function do_ajax_form_creditos_mob_validate_titulo_1()
  {
    var nomeCampo_titulo_1 = "titulo_1";
    var var_titulo_1 = scAjaxGetFieldText(nomeCampo_titulo_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_titulo_1(var_titulo_1, var_script_case_init, do_ajax_form_creditos_mob_validate_titulo_1_cb);
  } // do_ajax_form_creditos_mob_validate_titulo_1

  function do_ajax_form_creditos_mob_validate_titulo_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo_1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_titulo_1_cb

  // ---------- Validate texto_1
  function do_ajax_form_creditos_mob_validate_texto_1()
  {
    var nomeCampo_texto_1 = "texto_1";
    var var_texto_1 = scAjaxGetFieldEditorHtml(nomeCampo_texto_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_texto_1(var_texto_1, var_script_case_init, do_ajax_form_creditos_mob_validate_texto_1_cb);
  } // do_ajax_form_creditos_mob_validate_texto_1

  function do_ajax_form_creditos_mob_validate_texto_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_texto_1_cb

  // ---------- Validate titulo_2
  function do_ajax_form_creditos_mob_validate_titulo_2()
  {
    var nomeCampo_titulo_2 = "titulo_2";
    var var_titulo_2 = scAjaxGetFieldText(nomeCampo_titulo_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_titulo_2(var_titulo_2, var_script_case_init, do_ajax_form_creditos_mob_validate_titulo_2_cb);
  } // do_ajax_form_creditos_mob_validate_titulo_2

  function do_ajax_form_creditos_mob_validate_titulo_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo_2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_titulo_2_cb

  // ---------- Validate texto_2
  function do_ajax_form_creditos_mob_validate_texto_2()
  {
    var nomeCampo_texto_2 = "texto_2";
    var var_texto_2 = scAjaxGetFieldEditorHtml(nomeCampo_texto_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_texto_2(var_texto_2, var_script_case_init, do_ajax_form_creditos_mob_validate_texto_2_cb);
  } // do_ajax_form_creditos_mob_validate_texto_2

  function do_ajax_form_creditos_mob_validate_texto_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_texto_2_cb

  // ---------- Validate titulo_3
  function do_ajax_form_creditos_mob_validate_titulo_3()
  {
    var nomeCampo_titulo_3 = "titulo_3";
    var var_titulo_3 = scAjaxGetFieldText(nomeCampo_titulo_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_titulo_3(var_titulo_3, var_script_case_init, do_ajax_form_creditos_mob_validate_titulo_3_cb);
  } // do_ajax_form_creditos_mob_validate_titulo_3

  function do_ajax_form_creditos_mob_validate_titulo_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo_3";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_titulo_3_cb

  // ---------- Validate texto_3
  function do_ajax_form_creditos_mob_validate_texto_3()
  {
    var nomeCampo_texto_3 = "texto_3";
    var var_texto_3 = scAjaxGetFieldEditorHtml(nomeCampo_texto_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_texto_3(var_texto_3, var_script_case_init, do_ajax_form_creditos_mob_validate_texto_3_cb);
  } // do_ajax_form_creditos_mob_validate_texto_3

  function do_ajax_form_creditos_mob_validate_texto_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_texto_3_cb

  // ---------- Validate texto_requisitos
  function do_ajax_form_creditos_mob_validate_texto_requisitos()
  {
    var nomeCampo_texto_requisitos = "texto_requisitos";
    var var_texto_requisitos = scAjaxGetFieldEditorHtml(nomeCampo_texto_requisitos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_texto_requisitos(var_texto_requisitos, var_script_case_init, do_ajax_form_creditos_mob_validate_texto_requisitos_cb);
  } // do_ajax_form_creditos_mob_validate_texto_requisitos

  function do_ajax_form_creditos_mob_validate_texto_requisitos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_requisitos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_texto_requisitos_cb

  // ---------- Validate url_f_simulador
  function do_ajax_form_creditos_mob_validate_url_f_simulador()
  {
    var nomeCampo_url_f_simulador = "url_f_simulador";
    var var_url_f_simulador = scAjaxGetFieldText(nomeCampo_url_f_simulador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_url_f_simulador(var_url_f_simulador, var_script_case_init, do_ajax_form_creditos_mob_validate_url_f_simulador_cb);
  } // do_ajax_form_creditos_mob_validate_url_f_simulador

  function do_ajax_form_creditos_mob_validate_url_f_simulador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url_f_simulador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_url_f_simulador_cb

  // ---------- Validate id_status
  function do_ajax_form_creditos_mob_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_mob_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_creditos_mob_validate_id_status_cb);
  } // do_ajax_form_creditos_mob_validate_id_status

  function do_ajax_form_creditos_mob_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_mob_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_creditos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_creditos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_credito = scAjaxGetFieldHidden("id_credito");
    var var_credito = scAjaxGetFieldText("credito");
    var var_url_f = scAjaxGetFieldText("url_f");
    var var_img = scAjaxGetFieldText("img");
    var var_estilo = scAjaxGetFieldText("estilo");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_banner = scAjaxGetFieldText("banner");
    var var_slogan = scAjaxGetFieldText("slogan");
    var var_titulo_1 = scAjaxGetFieldText("titulo_1");
    var var_texto_1 = scAjaxGetFieldEditorHtml("texto_1");
    var var_titulo_2 = scAjaxGetFieldText("titulo_2");
    var var_texto_2 = scAjaxGetFieldEditorHtml("texto_2");
    var var_titulo_3 = scAjaxGetFieldText("titulo_3");
    var var_texto_3 = scAjaxGetFieldEditorHtml("texto_3");
    var var_texto_requisitos = scAjaxGetFieldEditorHtml("texto_requisitos");
    var var_url_f_simulador = scAjaxGetFieldText("url_f_simulador");
    ...
    scAjaxProcOn();
    x_ajax_form_creditos_mob_submit_form(var_id_credito, var_credito, var_url_f, var_img, var_estilo, var_descripcion, var_banner, var_slogan, var_titulo_1, var_texto_1, var_titulo_2, var_texto_2, var_titulo_3, var_texto_3, var_texto_requisitos, var_url_f_simulador, var_id_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_creditos_mob_submit_form_cb);
  } // do_ajax_form_creditos_mob_submit_form

  function do_ajax_form_creditos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_credito");
      scAjaxHideErrorDisplay("credito");
      scAjaxHideErrorDisplay("url_f");
      scAjaxHideErrorDisplay("img");
      scAjaxHideErrorDisplay("estilo");
      scAjaxHideErrorDisplay("descripcion");
      scAjaxHideErrorDisplay("banner");
      scAjaxHideErrorDisplay("slogan");
      scAjaxHideErrorDisplay("titulo_1");
      scAjaxHideErrorDisplay("texto_1");
      scAjaxHideErrorDisplay("titulo_2");
      scAjaxHideErrorDisplay("texto_2");
      scAjaxHideErrorDisplay("titulo_3");
      scAjaxHideErrorDisplay("texto_3");
      scAjaxHideErrorDisplay("texto_requisitos");
      scAjaxHideErrorDisplay("url_f_simulador");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_creditos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_creditos_mob_submit_form_cb
  function do_ajax_form_creditos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_creditos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_creditos_mob_navigate_form()
  {
    perform_ajax_form_creditos_mob_navigate_form();
  }

  function perform_ajax_form_creditos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("url_f_simulador");
    scAjaxHideErrorDisplay("id_status");
    var var_id_credito = document.F2.id_credito.value;
    ...
    scAjaxProcOn();
    x_ajax_form_creditos_mob_navigate_form(var_id_credito, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_creditos_mob_navigate_form_cb);
  } // do_ajax_form_creditos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_creditos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_creditos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_credito.value = scAjaxGetKeyValue("id_credito");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_creditos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_creditos_mob_navigate_form_cb
  function do_ajax_form_creditos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_creditos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_creditos_mob_navigate_form_cb_after_alert

  function sc_hide_form_creditos_mob_form()
  {
  ...
  ajax_field_list[0] = "id_credito";
  ajax_field_list[1] = "credito";
  ajax_field_list[2] = "url_f";
  ajax_field_list[3] = "img";
  ajax_field_list[4] = "estilo";
  ajax_field_list[5] = "descripcion";
  ajax_field_list[6] = "banner";
  ajax_field_list[7] = "slogan";
  ajax_field_list[8] = "titulo_1";
  ajax_field_list[9] = "texto_1";
  ajax_field_list[10] = "titulo_2";
  ajax_field_list[11] = "texto_2";
  ajax_field_list[12] = "titulo_3";
  ajax_field_list[13] = "texto_3";
  ajax_field_list[14] = "texto_requisitos";
  ajax_field_list[15] = "url_f_simulador";
  ajax_field_list[16] = "id_status";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_credito": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "credito": {"label": "Crédito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "url_f": {"label": "URL Puente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "img": {"label": "Imagen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estilo": {"label": "Estilo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "slogan": {"label": "Slogan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "titulo_1": {"label": "Titulo 1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_1": {"label": "Texto 1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "titulo_2": {"label": "Titulo 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_2": {"label": "Texto 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "titulo_3": {"label": "Titulo 3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_3": {"label": "Texto 3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_requisitos": {"label": "Texto Requisitos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "url_f_simulador": {"label": "URL Simulador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_status": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "titulo_3": new Array(),
    "texto_3": new Array(),
    "texto_requisitos": new Array(),
    "url_f_simulador": new Array(),
    "id_status": new Array()
  };
  ajax_field_mult["id_credito"][1] = "id_credito";
  ajax_field_mult["credito"][1] = "credito";
  ajax_field_mult["url_f"][1] = "url_f";
  ajax_field_mult["img"][1] = "img";
  ajax_field_mult["estilo"][1] = "estilo";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["banner"][1] = "banner";
  ajax_field_mult["slogan"][1] = "slogan";
  ajax_field_mult["titulo_1"][1] = "titulo_1";
  ajax_field_mult["texto_1"][1] = "texto_1";
  ajax_field_mult["titulo_2"][1] = "titulo_2";
  ajax_field_mult["texto_2"][1] = "texto_2";
  ajax_field_mult["titulo_3"][1] = "titulo_3";
  ajax_field_mult["texto_3"][1] = "texto_3";
  ajax_field_mult["texto_requisitos"][1] = "texto_requisitos";
  ajax_field_mult["url_f_simulador"][1] = "url_f_simulador";
  ajax_field_mult["id_status"][1] = "id_status";

  var ajax_field_id = {
    "id_credito": new Array("hidden_field_label_id_credito", "hidden_field_data_id_credito"),
    "credito": new Array("hidden_field_label_credito", "hidden_field_data_credito"),
    "url_f": new Array("hidden_field_label_url_f", "hidden_field_data_url_f"),
    "img": new Array("hidden_field_label_img", "hidden_field_data_img"),
    "estilo": new Array("hidden_field_label_estilo", "hidden_field_data_estilo"),
    ...
    "slogan": new Array("hidden_field_label_slogan", "hidden_field_data_slogan"),
    "titulo_1": new Array("hidden_field_label_titulo_1", "hidden_field_data_titulo_1"),
    "texto_1": new Array("hidden_field_label_texto_1", "hidden_field_data_texto_1"),
    "titulo_2": new Array("hidden_field_label_titulo_2", "hidden_field_data_titulo_2"),
    "texto_2": new Array("hidden_field_label_texto_2", "hidden_field_data_texto_2"),
    "titulo_3": new Array("hidden_field_label_titulo_3", "hidden_field_data_titulo_3"),
    "texto_3": new Array("hidden_field_label_texto_3", "hidden_field_data_texto_3"),
    "texto_requisitos": new Array("hidden_field_label_texto_requisitos", "hidden_field_data_texto_requisitos"),
    "url_f_simulador": new Array("hidden_field_label_url_f_simulador", "hidden_field_data_url_f_simulador"),
