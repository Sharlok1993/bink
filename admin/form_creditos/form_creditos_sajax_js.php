  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_creditos" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_credito
  function do_ajax_form_creditos_validate_id_credito()
  {
    var nomeCampo_id_credito = "id_credito";
    var var_id_credito = scAjaxGetFieldHidden(nomeCampo_id_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_id_credito(var_id_credito, var_script_case_init, do_ajax_form_creditos_validate_id_credito_cb);
  } // do_ajax_form_creditos_validate_id_credito

  function do_ajax_form_creditos_validate_id_credito_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_id_credito_cb

  // ---------- Validate credito
  function do_ajax_form_creditos_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldText(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_credito(var_credito, var_script_case_init, do_ajax_form_creditos_validate_credito_cb);
  } // do_ajax_form_creditos_validate_credito

  function do_ajax_form_creditos_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "credito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_credito_cb

  // ---------- Validate url_f
  function do_ajax_form_creditos_validate_url_f()
  {
    var nomeCampo_url_f = "url_f";
    var var_url_f = scAjaxGetFieldText(nomeCampo_url_f);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_url_f(var_url_f, var_script_case_init, do_ajax_form_creditos_validate_url_f_cb);
  } // do_ajax_form_creditos_validate_url_f

  function do_ajax_form_creditos_validate_url_f_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url_f";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_url_f_cb

  // ---------- Validate img
  function do_ajax_form_creditos_validate_img()
  {
    var nomeCampo_img = "img";
    var var_img = scAjaxGetFieldText(nomeCampo_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_img(var_img, var_script_case_init, do_ajax_form_creditos_validate_img_cb);
  } // do_ajax_form_creditos_validate_img

  function do_ajax_form_creditos_validate_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "img";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_img_cb

  // ---------- Validate estilo
  function do_ajax_form_creditos_validate_estilo()
  {
    var nomeCampo_estilo = "estilo";
    var var_estilo = scAjaxGetFieldText(nomeCampo_estilo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_estilo(var_estilo, var_script_case_init, do_ajax_form_creditos_validate_estilo_cb);
  } // do_ajax_form_creditos_validate_estilo

  function do_ajax_form_creditos_validate_estilo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estilo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_estilo_cb

  // ---------- Validate descripcion
  function do_ajax_form_creditos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_creditos_validate_descripcion_cb);
  } // do_ajax_form_creditos_validate_descripcion

  function do_ajax_form_creditos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_descripcion_cb

  // ---------- Validate banner
  function do_ajax_form_creditos_validate_banner()
  {
    var nomeCampo_banner = "banner";
    var var_banner = scAjaxGetFieldText(nomeCampo_banner);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_banner(var_banner, var_script_case_init, do_ajax_form_creditos_validate_banner_cb);
  } // do_ajax_form_creditos_validate_banner

  function do_ajax_form_creditos_validate_banner_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banner";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_banner_cb

  // ---------- Validate slogan
  function do_ajax_form_creditos_validate_slogan()
  {
    var nomeCampo_slogan = "slogan";
    var var_slogan = scAjaxGetFieldText(nomeCampo_slogan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_slogan(var_slogan, var_script_case_init, do_ajax_form_creditos_validate_slogan_cb);
  } // do_ajax_form_creditos_validate_slogan

  function do_ajax_form_creditos_validate_slogan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "slogan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_slogan_cb

  // ---------- Validate titulo_1
  function do_ajax_form_creditos_validate_titulo_1()
  {
    var nomeCampo_titulo_1 = "titulo_1";
    var var_titulo_1 = scAjaxGetFieldText(nomeCampo_titulo_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_titulo_1(var_titulo_1, var_script_case_init, do_ajax_form_creditos_validate_titulo_1_cb);
  } // do_ajax_form_creditos_validate_titulo_1

  function do_ajax_form_creditos_validate_titulo_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_titulo_1_cb

  // ---------- Validate texto_1
  function do_ajax_form_creditos_validate_texto_1()
  {
    var nomeCampo_texto_1 = "texto_1";
    var var_texto_1 = scAjaxGetFieldEditorHtml(nomeCampo_texto_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_texto_1(var_texto_1, var_script_case_init, do_ajax_form_creditos_validate_texto_1_cb);
  } // do_ajax_form_creditos_validate_texto_1

  function do_ajax_form_creditos_validate_texto_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_texto_1_cb

  // ---------- Validate titulo_2
  function do_ajax_form_creditos_validate_titulo_2()
  {
    var nomeCampo_titulo_2 = "titulo_2";
    var var_titulo_2 = scAjaxGetFieldText(nomeCampo_titulo_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_titulo_2(var_titulo_2, var_script_case_init, do_ajax_form_creditos_validate_titulo_2_cb);
  } // do_ajax_form_creditos_validate_titulo_2

  function do_ajax_form_creditos_validate_titulo_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_titulo_2_cb

  // ---------- Validate texto_2
  function do_ajax_form_creditos_validate_texto_2()
  {
    var nomeCampo_texto_2 = "texto_2";
    var var_texto_2 = scAjaxGetFieldEditorHtml(nomeCampo_texto_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_texto_2(var_texto_2, var_script_case_init, do_ajax_form_creditos_validate_texto_2_cb);
  } // do_ajax_form_creditos_validate_texto_2

  function do_ajax_form_creditos_validate_texto_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_texto_2_cb

  // ---------- Validate titulo_3
  function do_ajax_form_creditos_validate_titulo_3()
  {
    var nomeCampo_titulo_3 = "titulo_3";
    var var_titulo_3 = scAjaxGetFieldText(nomeCampo_titulo_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_titulo_3(var_titulo_3, var_script_case_init, do_ajax_form_creditos_validate_titulo_3_cb);
  } // do_ajax_form_creditos_validate_titulo_3

  function do_ajax_form_creditos_validate_titulo_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_titulo_3_cb

  // ---------- Validate texto_3
  function do_ajax_form_creditos_validate_texto_3()
  {
    var nomeCampo_texto_3 = "texto_3";
    var var_texto_3 = scAjaxGetFieldEditorHtml(nomeCampo_texto_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_texto_3(var_texto_3, var_script_case_init, do_ajax_form_creditos_validate_texto_3_cb);
  } // do_ajax_form_creditos_validate_texto_3

  function do_ajax_form_creditos_validate_texto_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_texto_3_cb

  // ---------- Validate texto_requisitos
  function do_ajax_form_creditos_validate_texto_requisitos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_texto_requisitos(var_texto_requisitos, var_script_case_init, do_ajax_form_creditos_validate_texto_requisitos_cb);
  } // do_ajax_form_creditos_validate_texto_requisitos

  function do_ajax_form_creditos_validate_texto_requisitos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_texto_requisitos_cb

  // ---------- Validate url_f_simulador
  function do_ajax_form_creditos_validate_url_f_simulador()
  {
    var nomeCampo_url_f_simulador = "url_f_simulador";
    var var_url_f_simulador = scAjaxGetFieldText(nomeCampo_url_f_simulador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_url_f_simulador(var_url_f_simulador, var_script_case_init, do_ajax_form_creditos_validate_url_f_simulador_cb);
  } // do_ajax_form_creditos_validate_url_f_simulador

  function do_ajax_form_creditos_validate_url_f_simulador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_url_f_simulador_cb

  // ---------- Validate id_status
  function do_ajax_form_creditos_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_creditos_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_creditos_validate_id_status_cb);
  } // do_ajax_form_creditos_validate_id_status

  function do_ajax_form_creditos_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_creditos_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_creditos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_creditos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_creditos_submit_form(var_id_credito, var_credito, var_url_f, var_img, var_estilo, var_descripcion, var_banner, var_slogan, var_titulo_1, var_texto_1, var_titulo_2, var_texto_2, var_titulo_3, var_texto_3, var_texto_requisitos, var_url_f_simulador, var_id_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_creditos_submit_form_cb);
  } // do_ajax_form_creditos_submit_form

  function do_ajax_form_creditos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_creditos_submit_form_cb_after_alert);
  } // do_ajax_form_creditos_submit_form_cb
  function do_ajax_form_creditos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_creditos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_creditos_navigate_form()
  {
    perform_ajax_form_creditos_navigate_form();
  }

  function perform_ajax_form_creditos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_creditos_navigate_form(var_id_credito, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_creditos_navigate_form_cb);
  } // do_ajax_form_creditos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_creditos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_creditos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_creditos_navigate_form_cb_after_alert);
  } // do_ajax_form_creditos_navigate_form_cb
  function do_ajax_form_creditos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_creditos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_creditos_navigate_form_cb_after_alert

  function sc_hide_form_creditos_form()
  {
