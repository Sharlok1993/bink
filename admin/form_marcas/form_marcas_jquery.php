...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_marca' + iSeqRow).bind('blur', function() { sc_form_marcas_id_marca_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_marcas_id_marca_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_marcas_id_marca_onfocus(this, iSeqRow) });
  $('#id_sc_field_marca' + iSeqRow).bind('blur', function() { sc_form_marcas_marca_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_marcas_marca_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_marcas_marca_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_status' + iSeqRow).bind('blur', function() { sc_form_marcas_id_status_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_marcas_id_status_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_marcas_id_status_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_marcas_id_marca_onblur(oThis, iSeqRow) {
  do_ajax_form_marcas_validate_id_marca();
  scCssBlur(oThis);
}

function sc_form_marcas_id_marca_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_marcas_id_marca_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_marcas_marca_onblur(oThis, iSeqRow) {
  do_ajax_form_marcas_validate_marca();
  scCssBlur(oThis);
}

function sc_form_marcas_marca_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_marcas_marca_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_marcas_id_status_onblur(oThis, iSeqRow) {
  do_ajax_form_marcas_validate_id_status();
  scCssBlur(oThis);
}

function sc_form_marcas_id_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_marcas_id_status_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_marcas_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_marcas')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
