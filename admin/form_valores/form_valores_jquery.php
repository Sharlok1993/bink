...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_valor' + iSeqRow).bind('blur', function() { sc_form_valores_id_valor_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_valores_id_valor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_factor_seg_vida' + iSeqRow).bind('blur', function() { sc_form_valores_factor_seg_vida_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_valores_factor_seg_vida_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_seg_auto' + iSeqRow).bind('blur', function() { sc_form_valores_seg_auto_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_valores_seg_auto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_factor_seg_auto' + iSeqRow).bind('blur', function() { sc_form_valores_factor_seg_auto_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_valores_factor_seg_auto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_factor_comision' + iSeqRow).bind('blur', function() { sc_form_valores_factor_comision_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_valores_factor_comision_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_factor_comision2' + iSeqRow).bind('blur', function() { sc_form_valores_factor_comision2_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_valores_factor_comision2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tia1' + iSeqRow).bind('blur', function() { sc_form_valores_tia1_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_valores_tia1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tia2' + iSeqRow).bind('blur', function() { sc_form_valores_tia2_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_valores_tia2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tia3' + iSeqRow).bind('blur', function() { sc_form_valores_tia3_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_valores_tia3_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tia4' + iSeqRow).bind('blur', function() { sc_form_valores_tia4_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_valores_tia4_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tia5' + iSeqRow).bind('blur', function() { sc_form_valores_tia5_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_valores_tia5_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cat' + iSeqRow).bind('blur', function() { sc_form_valores_cat_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_valores_cat_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_status' + iSeqRow).bind('blur', function() { sc_form_valores_id_status_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_valores_id_status_onchange(this, iSeqRow) })
...
function sc_form_valores_id_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_factor_seg_vida_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_seg_auto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_factor_seg_auto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_factor_comision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_factor_comision2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_tia1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_tia2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_tia3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_tia4_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_tia5_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_cat_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_valores_id_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_valores_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_valores')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
