...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_valores/form_valores_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_valores_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_valores_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['link_info']['remove_border']) {
...
<?php
 include_once("form_valores_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_valores'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_valores'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-2';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_factor_seg_vida_label" id="hidden_field_label_factor_seg_vida" style="<?php echo $sStyleHidden_factor_seg_vida; ?>"><span id="id_label_factor_seg_vida"><?php echo $this->nm_new_label['factor_seg_vida']; ?></span></TD>
    <TD class="scFormDataOdd css_factor_seg_vida_line" id="hidden_field_data_factor_seg_vida" style="<?php echo $sStyleHidden_factor_seg_vida; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_factor_seg_vida_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_seg_auto_label" id="hidden_field_label_seg_auto" style="<?php echo $sStyleHidden_seg_auto; ?>"><span id="id_label_seg_auto"><?php echo $this->nm_new_label['seg_auto']; ?></span></TD>
    <TD class="scFormDataOdd css_seg_auto_line" id="hidden_field_data_seg_auto" style="<?php echo $sStyleHidden_seg_auto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_seg_auto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_factor_seg_auto_label" id="hidden_field_label_factor_seg_auto" style="<?php echo $sStyleHidden_factor_seg_auto; ?>"><span id="id_label_factor_seg_auto"><?php echo $this->nm_new_label['factor_seg_auto']; ?></span></TD>
    <TD class="scFormDataOdd css_factor_seg_auto_line" id="hidden_field_data_factor_seg_auto" style="<?php echo $sStyleHidden_factor_seg_auto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_factor_seg_auto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_factor_comision_label" id="hidden_field_label_factor_comision" style="<?php echo $sStyleHidden_factor_comision; ?>"><span id="id_label_factor_comision"><?php echo $this->nm_new_label['factor_comision']; ?></span></TD>
    <TD class="scFormDataOdd css_factor_comision_line" id="hidden_field_data_factor_comision" style="<?php echo $sStyleHidden_factor_comision; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_factor_comision_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_factor_comision2_label" id="hidden_field_label_factor_comision2" style="<?php echo $sStyleHidden_factor_comision2; ?>"><span id="id_label_factor_comision2"><?php echo $this->nm_new_label['factor_comision2']; ?></span></TD>
    <TD class="scFormDataOdd css_factor_comision2_line" id="hidden_field_data_factor_comision2" style="<?php echo $sStyleHidden_factor_comision2; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_factor_comision2_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tia1_label" id="hidden_field_label_tia1" style="<?php echo $sStyleHidden_tia1; ?>"><span id="id_label_tia1"><?php echo $this->nm_new_label['tia1']; ?></span></TD>
    <TD class="scFormDataOdd css_tia1_line" id="hidden_field_data_tia1" style="<?php echo $sStyleHidden_tia1; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tia1_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tia2_label" id="hidden_field_label_tia2" style="<?php echo $sStyleHidden_tia2; ?>"><span id="id_label_tia2"><?php echo $this->nm_new_label['tia2']; ?></span></TD>
    <TD class="scFormDataOdd css_tia2_line" id="hidden_field_data_tia2" style="<?php echo $sStyleHidden_tia2; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tia2_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tia3_label" id="hidden_field_label_tia3" style="<?php echo $sStyleHidden_tia3; ?>"><span id="id_label_tia3"><?php echo $this->nm_new_label['tia3']; ?></span></TD>
    <TD class="scFormDataOdd css_tia3_line" id="hidden_field_data_tia3" style="<?php echo $sStyleHidden_tia3; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tia3_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tia4_label" id="hidden_field_label_tia4" style="<?php echo $sStyleHidden_tia4; ?>"><span id="id_label_tia4"><?php echo $this->nm_new_label['tia4']; ?></span></TD>
    <TD class="scFormDataOdd css_tia4_line" id="hidden_field_data_tia4" style="<?php echo $sStyleHidden_tia4; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tia4_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tia5_label" id="hidden_field_label_tia5" style="<?php echo $sStyleHidden_tia5; ?>"><span id="id_label_tia5"><?php echo $this->nm_new_label['tia5']; ?></span></TD>
    <TD class="scFormDataOdd css_tia5_line" id="hidden_field_data_tia5" style="<?php echo $sStyleHidden_tia5; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tia5_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cat_line" id="hidden_field_data_cat" style="<?php echo $sStyleHidden_cat; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cat_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['Lookup_id_status'][] = '1'; ?>
 </select></span>
</span><?php  }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_valores");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_valores");
 parent.scAjaxDetailHeight("form_valores", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
