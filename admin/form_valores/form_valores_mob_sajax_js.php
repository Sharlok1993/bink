  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_valores_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_valor
  function do_ajax_form_valores_mob_validate_id_valor()
  {
    var nomeCampo_id_valor = "id_valor";
    var var_id_valor = scAjaxGetFieldHidden(nomeCampo_id_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_id_valor(var_id_valor, var_script_case_init, do_ajax_form_valores_mob_validate_id_valor_cb);
  } // do_ajax_form_valores_mob_validate_id_valor

  function do_ajax_form_valores_mob_validate_id_valor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_id_valor_cb

  // ---------- Validate factor_seg_vida
  function do_ajax_form_valores_mob_validate_factor_seg_vida()
  {
    var nomeCampo_factor_seg_vida = "factor_seg_vida";
    var var_factor_seg_vida = scAjaxGetFieldText(nomeCampo_factor_seg_vida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_factor_seg_vida(var_factor_seg_vida, var_script_case_init, do_ajax_form_valores_mob_validate_factor_seg_vida_cb);
  } // do_ajax_form_valores_mob_validate_factor_seg_vida

  function do_ajax_form_valores_mob_validate_factor_seg_vida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_factor_seg_vida_cb

  // ---------- Validate seg_auto
  function do_ajax_form_valores_mob_validate_seg_auto()
  {
    var nomeCampo_seg_auto = "seg_auto";
    var var_seg_auto = scAjaxGetFieldText(nomeCampo_seg_auto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_seg_auto(var_seg_auto, var_script_case_init, do_ajax_form_valores_mob_validate_seg_auto_cb);
  } // do_ajax_form_valores_mob_validate_seg_auto

  function do_ajax_form_valores_mob_validate_seg_auto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_seg_auto_cb

  // ---------- Validate factor_seg_auto
  function do_ajax_form_valores_mob_validate_factor_seg_auto()
  {
    var nomeCampo_factor_seg_auto = "factor_seg_auto";
    var var_factor_seg_auto = scAjaxGetFieldText(nomeCampo_factor_seg_auto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_factor_seg_auto(var_factor_seg_auto, var_script_case_init, do_ajax_form_valores_mob_validate_factor_seg_auto_cb);
  } // do_ajax_form_valores_mob_validate_factor_seg_auto

  function do_ajax_form_valores_mob_validate_factor_seg_auto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_factor_seg_auto_cb

  // ---------- Validate factor_comision
  function do_ajax_form_valores_mob_validate_factor_comision()
  {
    var nomeCampo_factor_comision = "factor_comision";
    var var_factor_comision = scAjaxGetFieldText(nomeCampo_factor_comision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_factor_comision(var_factor_comision, var_script_case_init, do_ajax_form_valores_mob_validate_factor_comision_cb);
  } // do_ajax_form_valores_mob_validate_factor_comision

  function do_ajax_form_valores_mob_validate_factor_comision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_factor_comision_cb

  // ---------- Validate factor_comision2
  function do_ajax_form_valores_mob_validate_factor_comision2()
  {
    var nomeCampo_factor_comision2 = "factor_comision2";
    var var_factor_comision2 = scAjaxGetFieldText(nomeCampo_factor_comision2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_factor_comision2(var_factor_comision2, var_script_case_init, do_ajax_form_valores_mob_validate_factor_comision2_cb);
  } // do_ajax_form_valores_mob_validate_factor_comision2

  function do_ajax_form_valores_mob_validate_factor_comision2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_factor_comision2_cb

  // ---------- Validate tia1
  function do_ajax_form_valores_mob_validate_tia1()
  {
    var nomeCampo_tia1 = "tia1";
    var var_tia1 = scAjaxGetFieldText(nomeCampo_tia1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_tia1(var_tia1, var_script_case_init, do_ajax_form_valores_mob_validate_tia1_cb);
  } // do_ajax_form_valores_mob_validate_tia1

  function do_ajax_form_valores_mob_validate_tia1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_tia1_cb

  // ---------- Validate tia2
  function do_ajax_form_valores_mob_validate_tia2()
  {
    var nomeCampo_tia2 = "tia2";
    var var_tia2 = scAjaxGetFieldText(nomeCampo_tia2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_tia2(var_tia2, var_script_case_init, do_ajax_form_valores_mob_validate_tia2_cb);
  } // do_ajax_form_valores_mob_validate_tia2

  function do_ajax_form_valores_mob_validate_tia2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_tia2_cb

  // ---------- Validate tia3
  function do_ajax_form_valores_mob_validate_tia3()
  {
    var nomeCampo_tia3 = "tia3";
    var var_tia3 = scAjaxGetFieldText(nomeCampo_tia3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_tia3(var_tia3, var_script_case_init, do_ajax_form_valores_mob_validate_tia3_cb);
  } // do_ajax_form_valores_mob_validate_tia3

  function do_ajax_form_valores_mob_validate_tia3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_tia3_cb

  // ---------- Validate tia4
  function do_ajax_form_valores_mob_validate_tia4()
  {
    var nomeCampo_tia4 = "tia4";
    var var_tia4 = scAjaxGetFieldText(nomeCampo_tia4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_tia4(var_tia4, var_script_case_init, do_ajax_form_valores_mob_validate_tia4_cb);
  } // do_ajax_form_valores_mob_validate_tia4

  function do_ajax_form_valores_mob_validate_tia4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_tia4_cb

  // ---------- Validate tia5
  function do_ajax_form_valores_mob_validate_tia5()
  {
    var nomeCampo_tia5 = "tia5";
    var var_tia5 = scAjaxGetFieldText(nomeCampo_tia5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_tia5(var_tia5, var_script_case_init, do_ajax_form_valores_mob_validate_tia5_cb);
  } // do_ajax_form_valores_mob_validate_tia5

  function do_ajax_form_valores_mob_validate_tia5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia5";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_tia5_cb

  // ---------- Validate cat
  function do_ajax_form_valores_mob_validate_cat()
  {
    var nomeCampo_cat = "cat";
    var var_cat = scAjaxGetFieldText(nomeCampo_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_cat(var_cat, var_script_case_init, do_ajax_form_valores_mob_validate_cat_cb);
  } // do_ajax_form_valores_mob_validate_cat

  function do_ajax_form_valores_mob_validate_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_cat_cb

  // ---------- Validate id_status
  function do_ajax_form_valores_mob_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_mob_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_valores_mob_validate_id_status_cb);
  } // do_ajax_form_valores_mob_validate_id_status

  function do_ajax_form_valores_mob_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_mob_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_valores_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_valores_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_valores_mob_submit_form(var_id_valor, var_factor_seg_vida, var_seg_auto, var_factor_seg_auto, var_factor_comision, var_factor_comision2, var_tia1, var_tia2, var_tia3, var_tia4, var_tia5, var_cat, var_id_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_valores_mob_submit_form_cb);
  } // do_ajax_form_valores_mob_submit_form

  function do_ajax_form_valores_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_valores_mob_submit_form_cb_after_alert);
  } // do_ajax_form_valores_mob_submit_form_cb
  function do_ajax_form_valores_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_valores_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_valores_mob_navigate_form()
  {
    perform_ajax_form_valores_mob_navigate_form();
  }

  function perform_ajax_form_valores_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_valores_mob_navigate_form(var_id_valor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_valores_mob_navigate_form_cb);
  } // do_ajax_form_valores_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_valores_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_valores_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_valores_mob_navigate_form_cb
  function do_ajax_form_valores_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_valores_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_valores_mob_navigate_form_cb_after_alert

  function sc_hide_form_valores_mob_form()
  {
