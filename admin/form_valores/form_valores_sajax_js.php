  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_valores" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_valor
  function do_ajax_form_valores_validate_id_valor()
  {
    var nomeCampo_id_valor = "id_valor";
    var var_id_valor = scAjaxGetFieldHidden(nomeCampo_id_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_id_valor(var_id_valor, var_script_case_init, do_ajax_form_valores_validate_id_valor_cb);
  } // do_ajax_form_valores_validate_id_valor

  function do_ajax_form_valores_validate_id_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_id_valor_cb

  // ---------- Validate factor_seg_vida
  function do_ajax_form_valores_validate_factor_seg_vida()
  {
    var nomeCampo_factor_seg_vida = "factor_seg_vida";
    var var_factor_seg_vida = scAjaxGetFieldText(nomeCampo_factor_seg_vida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_factor_seg_vida(var_factor_seg_vida, var_script_case_init, do_ajax_form_valores_validate_factor_seg_vida_cb);
  } // do_ajax_form_valores_validate_factor_seg_vida

  function do_ajax_form_valores_validate_factor_seg_vida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factor_seg_vida";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_factor_seg_vida_cb

  // ---------- Validate seg_auto
  function do_ajax_form_valores_validate_seg_auto()
  {
    var nomeCampo_seg_auto = "seg_auto";
    var var_seg_auto = scAjaxGetFieldText(nomeCampo_seg_auto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_seg_auto(var_seg_auto, var_script_case_init, do_ajax_form_valores_validate_seg_auto_cb);
  } // do_ajax_form_valores_validate_seg_auto

  function do_ajax_form_valores_validate_seg_auto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "seg_auto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_seg_auto_cb

  // ---------- Validate factor_seg_auto
  function do_ajax_form_valores_validate_factor_seg_auto()
  {
    var nomeCampo_factor_seg_auto = "factor_seg_auto";
    var var_factor_seg_auto = scAjaxGetFieldText(nomeCampo_factor_seg_auto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_factor_seg_auto(var_factor_seg_auto, var_script_case_init, do_ajax_form_valores_validate_factor_seg_auto_cb);
  } // do_ajax_form_valores_validate_factor_seg_auto

  function do_ajax_form_valores_validate_factor_seg_auto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factor_seg_auto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_factor_seg_auto_cb

  // ---------- Validate factor_comision
  function do_ajax_form_valores_validate_factor_comision()
  {
    var nomeCampo_factor_comision = "factor_comision";
    var var_factor_comision = scAjaxGetFieldText(nomeCampo_factor_comision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_factor_comision(var_factor_comision, var_script_case_init, do_ajax_form_valores_validate_factor_comision_cb);
  } // do_ajax_form_valores_validate_factor_comision

  function do_ajax_form_valores_validate_factor_comision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factor_comision";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_factor_comision_cb

  // ---------- Validate factor_comision2
  function do_ajax_form_valores_validate_factor_comision2()
  {
    var nomeCampo_factor_comision2 = "factor_comision2";
    var var_factor_comision2 = scAjaxGetFieldText(nomeCampo_factor_comision2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_factor_comision2(var_factor_comision2, var_script_case_init, do_ajax_form_valores_validate_factor_comision2_cb);
  } // do_ajax_form_valores_validate_factor_comision2

  function do_ajax_form_valores_validate_factor_comision2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factor_comision2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_factor_comision2_cb

  // ---------- Validate tia1
  function do_ajax_form_valores_validate_tia1()
  {
    var nomeCampo_tia1 = "tia1";
    var var_tia1 = scAjaxGetFieldText(nomeCampo_tia1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_tia1(var_tia1, var_script_case_init, do_ajax_form_valores_validate_tia1_cb);
  } // do_ajax_form_valores_validate_tia1

  function do_ajax_form_valores_validate_tia1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_tia1_cb

  // ---------- Validate tia2
  function do_ajax_form_valores_validate_tia2()
  {
    var nomeCampo_tia2 = "tia2";
    var var_tia2 = scAjaxGetFieldText(nomeCampo_tia2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_tia2(var_tia2, var_script_case_init, do_ajax_form_valores_validate_tia2_cb);
  } // do_ajax_form_valores_validate_tia2

  function do_ajax_form_valores_validate_tia2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_tia2_cb

  // ---------- Validate tia3
  function do_ajax_form_valores_validate_tia3()
  {
    var nomeCampo_tia3 = "tia3";
    var var_tia3 = scAjaxGetFieldText(nomeCampo_tia3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_tia3(var_tia3, var_script_case_init, do_ajax_form_valores_validate_tia3_cb);
  } // do_ajax_form_valores_validate_tia3

  function do_ajax_form_valores_validate_tia3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_tia3_cb

  // ---------- Validate tia4
  function do_ajax_form_valores_validate_tia4()
  {
    var nomeCampo_tia4 = "tia4";
    var var_tia4 = scAjaxGetFieldText(nomeCampo_tia4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_tia4(var_tia4, var_script_case_init, do_ajax_form_valores_validate_tia4_cb);
  } // do_ajax_form_valores_validate_tia4

  function do_ajax_form_valores_validate_tia4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_tia4_cb

  // ---------- Validate tia5
  function do_ajax_form_valores_validate_tia5()
  {
    var nomeCampo_tia5 = "tia5";
    var var_tia5 = scAjaxGetFieldText(nomeCampo_tia5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_tia5(var_tia5, var_script_case_init, do_ajax_form_valores_validate_tia5_cb);
  } // do_ajax_form_valores_validate_tia5

  function do_ajax_form_valores_validate_tia5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tia5";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_tia5_cb

  // ---------- Validate cat
  function do_ajax_form_valores_validate_cat()
  {
    var nomeCampo_cat = "cat";
    var var_cat = scAjaxGetFieldText(nomeCampo_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_cat(var_cat, var_script_case_init, do_ajax_form_valores_validate_cat_cb);
  } // do_ajax_form_valores_validate_cat

  function do_ajax_form_valores_validate_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_cat_cb

  // ---------- Validate id_status
  function do_ajax_form_valores_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_valores_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_valores_validate_id_status_cb);
  } // do_ajax_form_valores_validate_id_status

  function do_ajax_form_valores_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_valores_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_valores_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_valores_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_valor = scAjaxGetFieldHidden("id_valor");
    var var_factor_seg_vida = scAjaxGetFieldText("factor_seg_vida");
    var var_seg_auto = scAjaxGetFieldText("seg_auto");
    var var_factor_seg_auto = scAjaxGetFieldText("factor_seg_auto");
    var var_factor_comision = scAjaxGetFieldText("factor_comision");
    var var_factor_comision2 = scAjaxGetFieldText("factor_comision2");
    var var_tia1 = scAjaxGetFieldText("tia1");
    var var_tia2 = scAjaxGetFieldText("tia2");
    var var_tia3 = scAjaxGetFieldText("tia3");
    var var_tia4 = scAjaxGetFieldText("tia4");
    var var_tia5 = scAjaxGetFieldText("tia5");
    var var_cat = scAjaxGetFieldText("cat");
    ...
    scAjaxProcOn();
    x_ajax_form_valores_submit_form(var_id_valor, var_factor_seg_vida, var_seg_auto, var_factor_seg_auto, var_factor_comision, var_factor_comision2, var_tia1, var_tia2, var_tia3, var_tia4, var_tia5, var_cat, var_id_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_valores_submit_form_cb);
  } // do_ajax_form_valores_submit_form

  function do_ajax_form_valores_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_valor");
      scAjaxHideErrorDisplay("factor_seg_vida");
      scAjaxHideErrorDisplay("seg_auto");
      scAjaxHideErrorDisplay("factor_seg_auto");
      scAjaxHideErrorDisplay("factor_comision");
      scAjaxHideErrorDisplay("factor_comision2");
      scAjaxHideErrorDisplay("tia1");
      scAjaxHideErrorDisplay("tia2");
      scAjaxHideErrorDisplay("tia3");
      scAjaxHideErrorDisplay("tia4");
      scAjaxHideErrorDisplay("tia5");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_valores_submit_form_cb_after_alert);
  } // do_ajax_form_valores_submit_form_cb
  function do_ajax_form_valores_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_valores_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_valores_navigate_form()
  {
    perform_ajax_form_valores_navigate_form();
  }

  function perform_ajax_form_valores_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cat");
    scAjaxHideErrorDisplay("id_status");
    var var_id_valor = document.F2.id_valor.value;
    ...
    scAjaxProcOn();
    x_ajax_form_valores_navigate_form(var_id_valor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_valores_navigate_form_cb);
  } // do_ajax_form_valores_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_valores']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_valores_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_valor.value = scAjaxGetKeyValue("id_valor");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_valores_navigate_form_cb_after_alert);
  } // do_ajax_form_valores_navigate_form_cb
  function do_ajax_form_valores_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_valores_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_valores_navigate_form_cb_after_alert

  function sc_hide_form_valores_form()
  {
  ...
  ajax_field_list[0] = "id_valor";
  ajax_field_list[1] = "factor_seg_vida";
  ajax_field_list[2] = "seg_auto";
  ajax_field_list[3] = "factor_seg_auto";
  ajax_field_list[4] = "factor_comision";
  ajax_field_list[5] = "factor_comision2";
  ajax_field_list[6] = "tia1";
  ajax_field_list[7] = "tia2";
  ajax_field_list[8] = "tia3";
  ajax_field_list[9] = "tia4";
  ajax_field_list[10] = "tia5";
  ajax_field_list[11] = "cat";
  ajax_field_list[12] = "id_status";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_valor": {"label": "Crédito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "factor_seg_vida": {"label": "Factor Seg Vida", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "seg_auto": {"label": "Seg Auto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "factor_seg_auto": {"label": "Factor Seg Auto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "factor_comision": {"label": "Factor Comision", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "factor_comision2": {"label": "Factor Comision 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tia1": {"label": "Tia 1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tia2": {"label": "Tia 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tia3": {"label": "Tia 3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tia4": {"label": "Tia 4", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tia5": {"label": "Tia 5", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cat": {"label": "CAT", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_status": {"label": "Id Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_valor": new Array(),
    "factor_seg_vida": new Array(),
    "seg_auto": new Array(),
    "factor_seg_auto": new Array(),
    "factor_comision": new Array(),
    "factor_comision2": new Array(),
    "tia1": new Array(),
    "tia2": new Array(),
    "tia3": new Array(),
    "tia4": new Array(),
  ...
  ajax_field_mult["id_valor"][1] = "id_valor";
  ajax_field_mult["factor_seg_vida"][1] = "factor_seg_vida";
  ajax_field_mult["seg_auto"][1] = "seg_auto";
  ajax_field_mult["factor_seg_auto"][1] = "factor_seg_auto";
  ajax_field_mult["factor_comision"][1] = "factor_comision";
  ajax_field_mult["factor_comision2"][1] = "factor_comision2";
  ajax_field_mult["tia1"][1] = "tia1";
  ajax_field_mult["tia2"][1] = "tia2";
  ajax_field_mult["tia3"][1] = "tia3";
  ajax_field_mult["tia4"][1] = "tia4";
  ajax_field_mult["tia5"][1] = "tia5";
  ajax_field_mult["cat"][1] = "cat";
  ajax_field_mult["id_status"][1] = "id_status";

  var ajax_field_id = {
    "id_valor": new Array("hidden_field_label_id_valor", "hidden_field_data_id_valor"),
    "factor_seg_vida": new Array("hidden_field_label_factor_seg_vida", "hidden_field_data_factor_seg_vida"),
    "seg_auto": new Array("hidden_field_label_seg_auto", "hidden_field_data_seg_auto"),
    "factor_seg_auto": new Array("hidden_field_label_factor_seg_auto", "hidden_field_data_factor_seg_auto"),
    "factor_comision": new Array("hidden_field_label_factor_comision", "hidden_field_data_factor_comision"),
    "factor_comision2": new Array("hidden_field_label_factor_comision2", "hidden_field_data_factor_comision2"),
    "tia1": new Array("hidden_field_label_tia1", "hidden_field_data_tia1"),
    "tia2": new Array("hidden_field_label_tia2", "hidden_field_data_tia2"),
    "tia3": new Array("hidden_field_label_tia3", "hidden_field_data_tia3"),
    "tia4": new Array("hidden_field_label_tia4", "hidden_field_data_tia4"),
    "tia5": new Array("hidden_field_label_tia5", "hidden_field_data_tia5"),
