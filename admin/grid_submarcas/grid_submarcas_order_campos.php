...
<?php
   ...
   $Ord_Cmp = new grid_submarcas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_submarcas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_submarcas'] = "id_submarcas";
   $tab_labels["id_submarcas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["id_submarcas"])) ? $_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["id_submarcas"] : "ID";
   $tab_ger_campos['id_marca'] = "on";
   $tab_def_campos['id_marca'] = "id_marca";
   $tab_labels["id_marca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["id_marca"])) ? $_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["id_marca"] : "Marca";
   $tab_ger_campos['submarca'] = "on";
   $tab_def_campos['submarca'] = "submarca";
   $tab_labels["submarca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["submarca"])) ? $_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["submarca"] : "Submarca";
   $tab_ger_campos['id_status'] = "on";
   $tab_def_campos['id_status'] = "id_status";
   $tab_labels["id_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["id_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_submarcas']['labels']["id_status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_submarcas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_submarcas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_submarcas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_submarcas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
