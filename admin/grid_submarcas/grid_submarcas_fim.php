...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_submarcas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FinancialOwn_____grid_submarcas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_submarcas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_submarcas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_submarcas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_submarcas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_submarcas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_submarcas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_submarcas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_submarcas']['embutida_filho'] as $ind => $sc_init)
          {
