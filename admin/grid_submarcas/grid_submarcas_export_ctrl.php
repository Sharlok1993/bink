<?php
@session_start() ;
$_SESSION['scriptcase']['grid_submarcas']['sc_process_barr'] = true;
require_once('../grid_submarcas/index.php');
unset($_SESSION['scriptcase']['grid_submarcas']['sc_process_barr']);
$ExportCtrl = new grid_submarcas_export_control;
$ExportCtrl->Export_barr();

class grid_submarcas_export_control
{
