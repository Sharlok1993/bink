  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_submarcas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_submarcas_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_submarcas
  function do_ajax_form_submarcas_mob_validate_id_submarcas()
  {
    var nomeCampo_id_submarcas = "id_submarcas";
    var var_id_submarcas = scAjaxGetFieldHidden(nomeCampo_id_submarcas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_mob_validate_id_submarcas(var_id_submarcas, var_script_case_init, do_ajax_form_submarcas_mob_validate_id_submarcas_cb);
  } // do_ajax_form_submarcas_mob_validate_id_submarcas

  function do_ajax_form_submarcas_mob_validate_id_submarcas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_submarcas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_mob_validate_id_submarcas_cb

  // ---------- Validate id_marca
  function do_ajax_form_submarcas_mob_validate_id_marca()
  {
    var nomeCampo_id_marca = "id_marca";
    var var_id_marca = scAjaxGetFieldSelect(nomeCampo_id_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_mob_validate_id_marca(var_id_marca, var_script_case_init, do_ajax_form_submarcas_mob_validate_id_marca_cb);
  } // do_ajax_form_submarcas_mob_validate_id_marca

  function do_ajax_form_submarcas_mob_validate_id_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_mob_validate_id_marca_cb

  // ---------- Validate submarca
  function do_ajax_form_submarcas_mob_validate_submarca()
  {
    var nomeCampo_submarca = "submarca";
    var var_submarca = scAjaxGetFieldText(nomeCampo_submarca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_mob_validate_submarca(var_submarca, var_script_case_init, do_ajax_form_submarcas_mob_validate_submarca_cb);
  } // do_ajax_form_submarcas_mob_validate_submarca

  function do_ajax_form_submarcas_mob_validate_submarca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "submarca";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_mob_validate_submarca_cb

  // ---------- Validate id_status
  function do_ajax_form_submarcas_mob_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_mob_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_submarcas_mob_validate_id_status_cb);
  } // do_ajax_form_submarcas_mob_validate_id_status

  function do_ajax_form_submarcas_mob_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_mob_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_submarcas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_submarcas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_submarcas = scAjaxGetFieldHidden("id_submarcas");
    var var_id_marca = scAjaxGetFieldSelect("id_marca");
    var var_submarca = scAjaxGetFieldText("submarca");
    ...
    scAjaxProcOn();
    x_ajax_form_submarcas_mob_submit_form(var_id_submarcas, var_id_marca, var_submarca, var_id_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_submarcas_mob_submit_form_cb);
  } // do_ajax_form_submarcas_mob_submit_form

  function do_ajax_form_submarcas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_submarcas");
      scAjaxHideErrorDisplay("id_marca");
      scAjaxHideErrorDisplay("submarca");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_submarcas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_submarcas_mob_submit_form_cb
  function do_ajax_form_submarcas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_submarcas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_submarcas_mob_navigate_form()
  {
    perform_ajax_form_submarcas_mob_navigate_form();
  }

  function perform_ajax_form_submarcas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("submarca");
    scAjaxHideErrorDisplay("id_status");
    var var_id_submarcas = document.F2.id_submarcas.value;
    ...
    scAjaxProcOn();
    x_ajax_form_submarcas_mob_navigate_form(var_id_submarcas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_submarcas_mob_navigate_form_cb);
  } // do_ajax_form_submarcas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_submarcas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_submarcas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_submarcas.value = scAjaxGetKeyValue("id_submarcas");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_submarcas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_submarcas_mob_navigate_form_cb
  function do_ajax_form_submarcas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_submarcas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_submarcas_mob_navigate_form_cb_after_alert

  function sc_hide_form_submarcas_mob_form()
  {
  ...
  ajax_field_list[0] = "id_submarcas";
  ajax_field_list[1] = "id_marca";
  ajax_field_list[2] = "submarca";
  ...
  var ajax_error_list = {
    "id_submarcas": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_marca": {"label": "Marca", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "submarca": {"label": "Submarca", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_submarcas": new Array(),
    "id_marca": new Array(),
    "submarca": new Array(),
    "id_status": new Array()
  };
  ajax_field_mult["id_submarcas"][1] = "id_submarcas";
  ajax_field_mult["id_marca"][1] = "id_marca";
  ajax_field_mult["submarca"][1] = "submarca";
  ajax_field_mult["id_status"][1] = "id_status";

  var ajax_field_id = {
    "id_submarcas": new Array("hidden_field_label_id_submarcas", "hidden_field_data_id_submarcas"),
    "id_marca": new Array("hidden_field_label_id_marca", "hidden_field_data_id_marca"),
    "submarca": new Array("hidden_field_label_submarca", "hidden_field_data_submarca"),
