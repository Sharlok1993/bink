  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_submarcas" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_submarcas_validate_id_submarcas()
  {
    var nomeCampo_id_submarcas = "id_submarcas";
    var var_id_submarcas = scAjaxGetFieldHidden(nomeCampo_id_submarcas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_validate_id_submarcas(var_id_submarcas, var_script_case_init, do_ajax_form_submarcas_validate_id_submarcas_cb);
  } // do_ajax_form_submarcas_validate_id_submarcas

  function do_ajax_form_submarcas_validate_id_submarcas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_validate_id_submarcas_cb

  // ---------- Validate id_marca
  function do_ajax_form_submarcas_validate_id_marca()
  {
    var nomeCampo_id_marca = "id_marca";
    var var_id_marca = scAjaxGetFieldSelect(nomeCampo_id_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_validate_id_marca(var_id_marca, var_script_case_init, do_ajax_form_submarcas_validate_id_marca_cb);
  } // do_ajax_form_submarcas_validate_id_marca

  function do_ajax_form_submarcas_validate_id_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_validate_id_marca_cb

  // ---------- Validate submarca
  function do_ajax_form_submarcas_validate_submarca()
  {
    var nomeCampo_submarca = "submarca";
    var var_submarca = scAjaxGetFieldText(nomeCampo_submarca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_validate_submarca(var_submarca, var_script_case_init, do_ajax_form_submarcas_validate_submarca_cb);
  } // do_ajax_form_submarcas_validate_submarca

  function do_ajax_form_submarcas_validate_submarca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_validate_submarca_cb

  // ---------- Validate id_status
  function do_ajax_form_submarcas_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_submarcas_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_submarcas_validate_id_status_cb);
  } // do_ajax_form_submarcas_validate_id_status

  function do_ajax_form_submarcas_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_submarcas_validate_id_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_submarcas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_submarcas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_submarcas_submit_form(var_id_submarcas, var_id_marca, var_submarca, var_id_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_submarcas_submit_form_cb);
  } // do_ajax_form_submarcas_submit_form

  function do_ajax_form_submarcas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_submarcas_submit_form_cb_after_alert);
  } // do_ajax_form_submarcas_submit_form_cb
  function do_ajax_form_submarcas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_submarcas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_submarcas_navigate_form()
  {
    perform_ajax_form_submarcas_navigate_form();
  }

  function perform_ajax_form_submarcas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_submarcas_navigate_form(var_id_submarcas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_submarcas_navigate_form_cb);
  } // do_ajax_form_submarcas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_submarcas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_submarcas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_submarcas_navigate_form_cb_after_alert);
  } // do_ajax_form_submarcas_navigate_form_cb
  function do_ajax_form_submarcas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_submarcas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_submarcas_navigate_form_cb_after_alert

  function sc_hide_form_submarcas_form()
  {
