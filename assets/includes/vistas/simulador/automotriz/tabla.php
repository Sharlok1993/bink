<form>
    ...
    <input type="hidden" name="enganche" class="enganche" value="<?php echo $enganche; ?>" id="enganche">
    <input type="hidden" name="plazo" class="plazo" value="<?php echo $plazo; ?>" id="plazo">
    <input type="hidden" name="seguro" class="seguro" value="<?php echo $seguro; ?>" id="seguro">
</form>
<div id="cabReporte" class="container my-3">
    <div class="media-container-row">
        <div class="col-md-12">
            <h2 style="color: var(--primary);">Tabla de amortización</h2>
            <h5 style="padding-bottom: 1rem!important; color: var(--primary);">Crédito Automotriz</h5>
            <h5 style="margin-top: 0; margin-bottom: .5rem;">Monto a financiar: <span class="monto-t">$0.00</span></h5>
            <h5 style="margin-top: 0; margin-bottom: .5rem;">Valor del auto: <span class="valor-t">$0.00</span></h5>
            ...
            <h5 style="margin-top: 0; margin-bottom: .5rem;">Enganche: <span class="enganche-t">$0.00</span></h5>
            <h5 style="margin-top: 0; margin-bottom: .5rem;">**Seguro anual financiado: <span class="seguro-t">$0.00</span></h5>
...
<table id="tablaAmort" cellspacing="0" style="width: 100% !important; margin-top: 6px; border-top: 1px solid #efefef; border-bottom: 1px solid #efefef; margin-bottom: 0; border-color: grey;">
    <thead>
        <tr>
            ...
            <th style="text-align: center;">Seguro de Auto</th>
...
<div class="col-12 d-flex justify-content-center">
    <div class="col-md-8 col-sm-12 p-2">
        <div id="btn-ccoc" class="p-1">
            <a href="<?php echo $ruta; ?>simulador/credito-automotriz" class="btn btn-primary p-2" style="font-size: 1.2rem; width:100%!important; border-radius:50rem;">Calcular con otra cantidad</a>
        </div>
    </div>
</div>