        ...
        <div class="col-md-8 text-center mx-auto p-4">
            <div class="">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo $ruta; ?>assets/img/credito_personal_icono.svg" style="width: 100px;">
                </div>
                <div class="d-flex justify-content-center my-3">
                    <h4>Crédito Personal</h4>
                </div>
            </div>
            <form id="simulador" action="<?php echo $ruta; ?>tabla-de-amortizacion/personal" method="POST" class="" data-form-title="personal">
                <h5>¿Cuánto necesitas?</h5>
                <div class="col-12 d-flex justify-content-center">
                    <input type="text" id="valorM" name="valorM" placeholder="$" data-form-field="valorM" class="col-6 p-3" style="background: var(--light); border: 1px solid #eeeeee; border-radius: 5px; color: var(--gray); text-align: center;">
                    <input type="text" name="valor" required="required" class="d-none" value="" id="valor">
                </div>
                <hr class="my-5">
                <h5>¿Cuál es plan que más te acomoda?</h5>
                <div data-for="plazo" class="col-12 plazoS">
                ...
                <div class="form-row detalles d-none">
                    ...
                    <div class="col-12 mt-2 mb-1">
                        <h5 style="text-align: center;">El pago mensual promedio sería:</h5>
                    </div>
                    <div class="col-12">
                        <h1 class="pmp" style="text-align: center; color: var(--blue); font-weight: bold; font-size: 62px;">$1,010.00</h1>
                    ...
                    <table class="table table-sm">
                        <tbody>
                            ...
                            <tr class="row">
                                ...
                                <td class="col-5 cat-t" style="text-align: left; font-size: 1.2rem;">0% sin IVA</td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="col-12 d-flex justify-content-center">
