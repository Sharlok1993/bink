    ...
    function amortizacion(valor,monto,plazo){
        ...
        var totalpm_=totalpm.toFixed(0);
            ...
            for (var i = 1; i <= plazo; i++){
                ...
                var totalpm_=totalpm.toFixed(0);
                var cont=c+1;
                var tabla='<tr><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;">'+cont+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;">$'+moneda((monto).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;">$'+moneda((pagoCapi).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;">$'+moneda((pagoIm).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;">$'+moneda((ivaInte).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;">$'+moneda((segVid).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;">$'+moneda((totalpm).toFixed(0))+'</td></tr>';
            ...
            var filaTotales='<tr><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;font-weight: bolder;">Totales</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;font-weight: bolder;">$0</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;font-weight: bolder;">$'+moneda((pagoCapiT).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;font-weight: bolder;">$'+moneda((pagoImT).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;font-weight: bolder;">$'+moneda((ivaInteT).toFixed(0))+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;font-weight: bolder;">$'+moneda(segVidT)+'</td><td style="color: #201751; text-align: center; padding: .75rem; vertical-align: top; border-top: 1px solid #dee2e6;font-weight: bolder;">$'+moneda((totalpmT).toFixed(0))+'</td></tr>';
...
<script type="text/javascript">
    $('#pdf').click(function (){
        setTimeout(function(){
            ...
            pdf.setFontSize(14);
            pdf.setTextColor(0,155,219);
            pdf.text(15,40,"Crédito personal");
            pdf.setFontSize(10);
            ...
            pdf.save('tabla-amortizacion-personal.pdf');
        }, 100);
        setTimeout(function(){
        }, 200);
    });
