        ...
        <div class="col-md-8 text-center mx-auto p-4">
            <div>
                <div class="d-flex justify-content-center" style="">
                    <img src="<?php echo $ruta; ?>assets/img/credito_nomina_icono.svg" style="width: 100px;">
                </div>
                <div class="d-flex justify-content-center my-3">
                    <h4>Crédito Nómina</h4>
                </div>
            </div>
            <form id="simulador" action="<?php echo $ruta; ?>tabla-de-amortizacion/nomina" method="POST" class="" data-form-title="personal">     
                <div class="col-12">
                    <h5>¿Cuánto necesitas?</h5>
                    <p>En crédito nómina los montos van de $10,000 hasta $500,000</p>
                </div>
                <div class="d-flex justify-content-center">
                    <input type="text" id="valorM" name="valorM" placeholder="$" data-form-field="valorM" required="required" class="col-md-6 p-3" value="" autocomplete="off" style="background: var(--light); border: 1px solid #eeeeee; border-radius: 5px; color: var(--gray); text-align: center;">
                    <input type="text" name="valor" required="required" class="d-none" value="" id="valor">
                </div>
                <hr class="col-12">
                <h5>¿Cuál es plan que más te acomoda?</h5>
                <div class="col-12">
                    <select name="plazo" data-form-field="select" class="col-12 p-3" id="plazo" style="background: var(--light); border: 1px solid #eeeeee; border-radius: 5px; color: var(--gray); text-align: center;">
                ...
                <hr class="col-12">
                <p>El pago mensual promedio sería:</p>
                <div class="col-12">
