...
<div id="cabReporte">
    <div class="media-container-row">
        <div class="col-md-12">
            ...
            <h5 style="padding-bottom: 1rem!important; color: var(--primary);">Crédito Nómina</h5>
...
<div class="col-12 d-flex justify-content-center">
    <div class="col-md-8 col-sm-12 p-2">
        <div id="btn-ccoc" class="p-1">
            <a href="<?php echo $ruta; ?>simulador/credito-nomina" class="btn btn-primary p-2" style="font-size: 1.2rem; width:100%!important; border-radius:50rem;">Calcular con otra cantidad</a>
        </div>
    </div>
</div>